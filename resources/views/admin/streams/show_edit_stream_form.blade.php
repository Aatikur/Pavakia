                    ...
                    <form id="demo-form2" method="POST" action="{{route('admin.update_stream',['id'=>$stream_record->id])}}" data-parsley-validate class="form-horizontal form-label-left" enctype='multipart/form-data'>
                      ...
                      <div class="form-group">
                        <div>
                          <label >Update Stream</label>
                            <input type="text" value="{{$stream_record->stream}}" name="stream" class="form-control"   autocomplete="off" />
                        </div>
                      </div>
                       @error('Stream')
                     ...
                     <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button type="submit" name="submit" class="btn btn-primary">Update Stream</button>
                        </div>
                     </div>
                   </form>
                  </div>
